...
<div class="container mt-4">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body custom-padding">
            <div class="row">
                <div class="col-md-6">
                    <a href="<?php echo base_url('index.php/reports/user'); ?>" class="card text-decoration-none shadow-sm p-3">
                ...
                <div class="col-md-6">
                    <a href="<?php echo base_url('index.php/reports/login'); ?>" class="card text-decoration-none shadow-sm p-3">
                        <div class="card-body text-center">
